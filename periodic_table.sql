...
INSERT INTO public.types OVERRIDING SYSTEM VALUE VALUES (2, 'metalloid');
INSERT INTO public.types OVERRIDING SYSTEM VALUE VALUES (3, 'nonmetal');
...
--
-- Name: elements unique_elements_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_elements_name UNIQUE (name);


--
-- Name: elements unique_elements_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_elements_symbol UNIQUE (symbol);
